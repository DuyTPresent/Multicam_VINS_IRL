...
#define SHOW_LOG_DEBUG 1        // SHOW THE LOG (INFO)
...
namespace MCVIO
{
    ...
    // Monocular
    class MCVIOcamera : public MCVIOsensor       // KE THUA TRONG LAP TRINH HUONG DOI TUONG
    {
    public:
        ...
        int pub_count = 0;
        bool PUB_THIS_FRAME = false;                  // PUB_THIS_FRAME 
        int init_pub = 0;
        ...
        detector_type detector_type_ = ORB; 
    };
